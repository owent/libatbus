...
#define ATBUS_CHANNEL_IOS_CHECK_FLAG(f, v) (0 != ((f) & (static_cast<decltype(f)>(1) << static_cast<int>(v))))
#define ATBUS_CHANNEL_IOS_SET_FLAG(f, v) (f) |= (static_cast<decltype(f)>(1) << static_cast<int>(v))
#define ATBUS_CHANNEL_IOS_UNSET_FLAG(f, v) (f) &= ~(static_cast<decltype(f)>(1) << static_cast<int>(v))
