...
struct msg_handler {
  ...
  static ATBUS_MACRO_API int send_transfer_rsp(node &n, ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES,
                                               int32_t ret_code);
  ...
  // ========================= 接收handle =========================
  static ATBUS_MACRO_API int on_recv_data_transfer_req(node &n, connection *conn,
                                                       ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                                       int errcode);
  static ATBUS_MACRO_API int on_recv_data_transfer_rsp(node &n, connection *conn,
                                                       ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                                       int errcode);

  static ATBUS_MACRO_API int on_recv_custom_cmd_req(node &n, connection *conn,
                                                    ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                                    int errcode);
  static ATBUS_MACRO_API int on_recv_custom_cmd_rsp(node &n, connection *conn,
                                                    ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                                    int errcode);

  static ATBUS_MACRO_API int on_recv_node_sync_req(node &n, connection *conn,
                                                   ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                                   int errcode);
  static ATBUS_MACRO_API int on_recv_node_sync_rsp(node &n, connection *conn,
                                                   ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                                   int errcode);
  static ATBUS_MACRO_API int on_recv_node_reg_req(node &n, connection *conn,
                                                  ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                                  int errcode);
  static ATBUS_MACRO_API int on_recv_node_reg_rsp(node &n, connection *conn,
                                                  ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                                  int errcode);
  static ATBUS_MACRO_API int on_recv_node_conn_syn(node &n, connection *conn,
                                                   ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                                   int errcode);
  static ATBUS_MACRO_API int on_recv_node_ping(node &n, connection *conn,
                                               ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                               int errcode);
  static ATBUS_MACRO_API int on_recv_node_pong(node &n, connection *conn,
                                               ::atbus::protocol::msg ATBUS_MACRO_RVALUE_REFERENCES, int status,
                                               int errcode);
};
}  // namespace atbus
